...
const steps = [
  {
    ...
    tag: "Dia 1",
    title: "Agende a demo",
    desc: "Você conversa com nossa equipe e conhece o sistema rodando com dados reais do seu segmento.",
    detail: "Sem script genérico. Mostramos o que importa pra sua clínica.",
  },
  {
    n: "02",
    icon: FileSignature,
    tag: "Semana 1",
    title: "Fechamos contrato",
    desc: "Definimos o plano, assinamos e você não precisa fazer mais nada. Nossa equipe assume daqui em diante.",
    detail: "Escolha o plano, assine digitalmente. Pronto — a responsabilidade é nossa.",
  },
  {
    n: "03",
    icon: Rocket,
    ...
    desc: "Configuramos tudo — agenda, serviços, equipe, cobranças e marketing. Você começa a usar no dia combinado.",
    detail: "Zero configuração do seu lado. Zero stress.",
  },
];
